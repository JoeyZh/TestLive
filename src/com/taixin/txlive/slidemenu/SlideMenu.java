 ...
 */
package com.taixin.txlive.slidemenu;
...
public class SlideMenu extends ViewGroup {
	...
	private OnContentBackUpListener mContentBackUpListener;
	...
	public void setOnContentBackUpListener(OnContentBackUpListener contentBackUpListener)
	{
		mContentBackUpListener = contentBackUpListener;
	}
	/**
	 * Get current state
	 * 
	...
	private boolean isTapInContent(float x, float y) {
		...
		if (null != content) {
			...
			contentflag = mContentHitRect.contains((int) x, (int) y);
			return contentflag;
		}
		return false;
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			return isOpen() && mIsTapInContent && STATE_OPEN_RIGHT != currentState;
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(dy) >= mTouchSlop && (mIsTapInContent||STATE_OPEN_RIGHT == currentState)
			...
			if (Math.abs(dx) >= mTouchSlop && (mIsTapInContent||STATE_OPEN_RIGHT == currentState)) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (STATE_DRAG != currentState&&STATE_OPEN_RIGHT !=currentState) {
				mLastMotionX = x;
				return false;
			}
			drag(mLastMotionX, x);
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		if (KeyEvent.ACTION_UP == event.getAction()) {
			...
			case KeyEvent.KEYCODE_BACK:
				...
				{
					if(mContentBackUpListener!=null)
						mContentBackUpListener.onBackUp();
				}
				break;
	...
	public interface OnContentBackUpListener
	{
